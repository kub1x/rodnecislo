...
var RodneCislo = exports.RodneCislo = /*#__PURE__*/function () {
...
function _parseRawInput(inputText) {
  ...
  try {
    ...
    _classPrivateFieldSet(_error, this, 'Failed to parse input string');
    return false;
  }
  if (_classPrivateFieldGet(_longFormat, this)) {
...
function _parseBirthYear() {
  ...
  if (!_classPrivateFieldGet(_longFormat, this) && _classPrivateFieldGet(_YYYY, this) <= YEAR53) {
    ...
    // 1.1.2054 - until ever
    _classPrivateFieldSet(_error, this, 'We didn\'t think about this yet...');
    return false;
  }
  return true;
}
